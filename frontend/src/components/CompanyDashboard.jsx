...
import { LogOut, Plus, Package, CheckCircle, XCircle, Clock, Edit, Trash2, Settings } from "lucide-react";
...
export default function CompanyDashboard({ user, onLogout, onSettings }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-purple-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">لوحة التحكم - شركة التوصيل</p>
            </div>
          ...
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle className="text-xl text-right">إضافة طلب جديد</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleAddOrder} className="space-y-4 mt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData({ ...formData, order_price: e.target.value })}
                        className="mt-1"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <Select value={formData.status} onValueChange={(value) => setFormData({ ...formData, status: value })}>
                        <SelectTrigger data-testid="status-select" className="mt-1">
                  ...
                  <Button type="submit" data-testid="submit-order-button" className="w-full">
                    إضافة الطلب
                  </Button>
                </form>
              </DialogContent>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-xl text-right">تعديل الطلب</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleEditOrder} className="space-y-4 mt-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div>
                <Label>الحالة *</Label>
                <Select value={formData.status} onValueChange={(value) => setFormData({ ...formData, status: value })}>
                  <SelectTrigger data-testid="edit-status-select" className="mt-1">
                    <SelectValue placeholder="اختر الحالة" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="جاري">جاري</SelectItem>
            ...
            <Button type="submit" data-testid="submit-edit-button" className="w-full">
              حفظ التعديلات
            </Button>
          </form>
        </DialogContent>
